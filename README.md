...
**Latest updates**:
- Tags can now be added as array elements if comma+1 space separated, in preparation for search/filter functionality. EJS not yet updated to display tags properly (even though they show up on localhost).
