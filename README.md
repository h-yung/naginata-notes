...
**Optimizations**: 
- **[IN PROGRESS]** Make filterable by tag. UI is set up as are params in backend. Working on frontend js. Nothing is really accessible yet - the toggle for example needs a keydown listener to be triggered by 'Enter' or spacebar.
